 ...
 * Copyright (C) 2017 Keepsafe Software
 *
...
public class Output {
    ...
    static void printFieldRefs(ClassRef[] classes) {
        ...
        for (int i = 0; i < classes.length; i++) {
            ...
            for (int j = 0; j < fields.length; j++) {
                ...
                out.println(descriptorToDot(ref.getDeclaringClassName()) +
    ...
    private static void printXmlMethods(ClassRef cref) {
        ...
        for (int i = 0; i < methods.length; i++) {
            ...
            String declClassName = mref.getDeclaringClassName();
            boolean constructor;
    ...
    /*
     * MODIFICATIONS:
     *   primitiveTypeLabel, descriptorToDot both made public.
     */
