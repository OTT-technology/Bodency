...
public class MethodRef extends AbstractRef {
    private String mReturnType, mMethodName;
    private String[] mArgTypes;

    /**
     * Initializes a new field reference.
     */
    public MethodRef(String declaringClass, String[] argTypes, String returnType,
                     String methodName) {
    ...
    public boolean equals(Object o) {
        ...
        return other.mDeclaringClass.equals(mDeclaringClass) &&
    ...
    @Override
    public int hashCode() {
        return mDeclaringClass.hashCode() ^ mReturnType.hashCode() ^
    ...
    public String toString() {
        ...
        sb.append("; argumentTypeNames -> ");
        sb.append(Arrays.toString(mArgTypes));
